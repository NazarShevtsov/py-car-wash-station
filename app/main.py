class Car:
    def __init__(self, comfort_cl: int, clean_mark: int, brand: str) -> None:
        self.comfort_class = comfort_cl
        self.clean_mark = clean_mark
        self.brand = brand


class CarWashStation:
    def __init__(self, dist: float, power: int, rate: float, num: int) -> None:
